...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def load_SDM_state_dict(self, state_dict_SDM, **kwargs):
        ...
        for k, v in state_dict.items(): # Skip the LoRA layers, we have zero-initialized in attention.py
            if "adapterffn" in k or "add_k_proj" in k or "add_v_proj" in k or "add_out_proj" in k: #or "encoder_hid_proj" in k
                continue
            if "encoder_hid_proj" in k:
                continue
    ...
    def forward(
        ...
        relation_embs: torch.Tensor = None,
        ...
        if self.encoder_hid_proj is not None and self.config.encoder_hid_dim_type == "text_proj":
            ...
            if relation_embs is not None:
                relation_embs = self.encoder_hid_proj(relation_embs)
